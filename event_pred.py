...
# from scipy.signal import find_peaks
peaks, properties = find_peaks(y, prominence=16)

print([frames[peaks[i]+int(front_zeros[peaks[i]])] for i in range(len(peaks))])
...
for i in range(len(peaks)):
    ...
    print(frames[peaks[i]+int(front_zeros[peaks[i]])],end=',')
...
ang, _ = find_peaks(ang, distance=8)
